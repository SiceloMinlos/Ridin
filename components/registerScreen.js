...
export default function LoginScreen() {
    ...
    const handleLogin = () => {
        ...
        console.log("Bouncing over to the login secion")
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.inputContainer}>
                ...
                />
                <View style={styles.iconContainer}>
                    <FontAwesomeIcon name='envelope' size={18} color={'black'} />
                </View>
            </View>
            ...
            <Text style={styles.Rtext}>Got an account? <Text
